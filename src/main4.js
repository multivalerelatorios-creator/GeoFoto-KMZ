...
const $=s=>document.querySelector(s), LOCAL='geofoto_offline_v2', CFG='geofoto_cfg_v1', IDENTITY='gf_identity', APP_VERSION='1.2.1'
...
function renderCapture(){
 ...
 $('#capture').innerHTML=`<div class="grid2 mobile-main"><div class="card capture"><h3>Câmera de campo</h3>
 ...
 <div id="pointNameHint" class="muted small">Informe a identificação para liberar a câmera.</div>
 <div class="sensor-panel"><div id="camState" class="sensor-state waiting"><b>📷 Câmera</b><span>Inicializando…</span></div><div id="gpsState" class="sensor-state waiting"><b>⌖ GPS</b><span>Localizando…</span></div></div>
 <button class="btn secondary sensor-retry" id="retrySensors" type="button">Reativar câmera e GPS</button>
 ...
 <div class="actions"><button class="btn secondary" id="gps">Atualizar GPS</button></div><div class="actions hidden" id="shareActions"><button class="btn primary" id="shareBtn">📤 Enviar</button><button class="btn secondary" id="downloadBtn">⬇ Salvar foto</button></div>
 <div id="saveStatus" class="statusline">Aguardando câmera e GPS...</div><div id="camInfo" class="muted small"></div><div id="gpsInfo" class="muted small"></div>
...
async function startCameraAndGps(){await Promise.allSettled([startCamera(),getGps()]);updateCaptureReady()}
